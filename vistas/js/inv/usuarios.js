...
$(document).on("click", ".btnEditarUsuario", function(){
	...
	$.ajax({
		...
		success: function(respuesta){
			...
			if(respuesta["perfil"] == "Administrador"){$("#editarPerfil").val('1');}else if(respuesta["perfil"] == "Tecnologia"){$("#editarPerfil").val('2');}else if(respuesta["perfil"] == "Administrativo"){$("#editarPerfil").val('3');}else if(respuesta["perfil"]=='Consulta'){$('#editarPerfil').val('4');};
