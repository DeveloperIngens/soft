...
class AjaxUsuarios{
	...
	/*=============================================
	VALIDAR NO REPETIR CORREO REGISTRO
	=============================================*/	
	...
	public $idUsuarioEdicion;

	public function ajaxEditarUsuarioPropio(){

		$item = "id_usuario";
		$valor = $this->idUsuarioEdicion;
...
EDITAR USUARIO PROPIO
=============================================*/
if(isset($_POST["idUsuarioEdicion"])){

	$editar = new AjaxUsuarios();
	$editar -> idUsuarioEdicion = $_POST["idUsuarioEdicion"];
...
/*=============================================
VALIDAR NO REPETIR CORREO NUMERO IDENTIFICACION
=============================================*/

if(isset( $_POST["validarIdentificacion"])){

	$valIdentificacion = new AjaxUsuarios();
